        ...
        <div className="roadmap">
          ...
          <div className="roadmap__wrapper">
            ...
            <picture>
              ...
              <img
                className="roadmap__image-1 reveal"
                src={roadmap1MobilePng}
                alt=""
              />
            </picture>
            <div className="roadmap__box">
              <div className="roadmap__box-left">
                <h4 className="roadmap__title">Birth of Larry</h4>
                <p className="roadmap__text">
                  -Building a strong and responsible team
                </p>
                <p className="roadmap__text">-Market analysis</p>
                <p className="roadmap__text">
                ...
                <picture className="d-flex">
                  ...
                  <img
                    className="roadmap__ava roadmap__ava-l reveal"
                    src={roadmap6Png}
                    alt=""
                  />
                </picture>
                <h4 className="roadmap__title">Office story</h4>
                <p className="roadmap__text">-Forming 1st NFT collection</p>
                <p className="roadmap__text">
                ...
                <picture className="d-flex">
                  ...
                  <img
                    className="roadmap__ava roadmap__ava-r reveal"
                    src={roadmap2Png}
                    alt=""
                  />
                </picture>
                <h4 className="roadmap__title">African trip</h4>
                <p className="roadmap__text">-Forming 2nd NFT collection</p>
                <p className="roadmap__text">
                ...
                <h4 className="roadmap__title">European trip</h4>
                <p className="roadmap__text">-Forming 3rd NFT collection</p>
                <p className="roadmap__text">
                ...
                <h4 className="roadmap__title">Asian trip</h4>
                <p className="roadmap__text">-Forming 4th NFT collection</p>
                <p className="roadmap__text">-Announce our P2E metaverse</p>
                <p className="roadmap__text">
                ...
                <h4 className="roadmap__title">Colonizing Metaverse</h4>
                <p className="roadmap__text">
                  -P2E Metaverse &quot;LarryLand&quot; Demo
                </p>
                <p className="roadmap__text">-IDO</p>
                <p className="roadmap__text">-TGE</p>
                <p className="roadmap__text">
            ...
            <picture>
              ...
              <img
                className="roadmap__image-1"
                src={roadmap8MobilePng}
                alt=""
              />
            </picture>
          </div>
            ...
            <div className="roadmap__box">
              ...
              <div className="roadmap__box-right">
                <picture>
                  ...
                  <img
                    className="roadmap__larry-1 reveal"
                    src={larry1Png}
                    alt=""
                  />
                </picture>
                <picture>
                  ...
                  <img
                    className="roadmap__larry-2 reveal"
                    src={larry2Png}
                    alt=""
                  />
                </picture>
                <picture>
                  ...
                  <img
                    className="roadmap__larry-3 reveal"
                    src={larry3Png}
                    alt=""
                  />
                </picture>
