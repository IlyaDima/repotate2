      ...
      <div className="team__players">
        <div className="team__player">
          ...
          <div className="team__player-wrapper">
            ...
            <p className="team__player-expanded">
              Dio is the shark of the office business. He doesn&apos;t care
              about any whales because he has an army of hamsters in his office.
              In a week you can meet him in several states in the company of
              people from completely different fields discussing the creation of
              10 more projects... he does not know what is a lot With 10+ years
              of experience in the financial business sector he knows how to
              make a well organized working structure and make numbers working
              for him.
            </p>
        ...
        <div className="team__player">
          ...
          <div className="team__player-wrapper">
            ...
            <p className="team__player-expanded">
              Mary is the golden hand of visualizing anytype of idea. Sometimes
              you may not understand exactly what Mary is talking about, but
              don&apos;t ask her to explain, you are witnessing the birth of
              art. Catching Mary outside her workplace is like finding a
              dinosaur egg in a sandbox, her workplace looks more like an
              independent hippie state. With 5+ years of experience creating art
              for all sorts of NFT projects, she knows how to create art
              that&apos;s impossible to take your eyes off.
            </p>
            <div className="team__player-socials">
              <a
                className="team__player-socials-icon team__player-socials-icon--discord"
        ...
        <div className="team__player">
          ...
          <div className="team__player-wrapper">
            ...
            <p className="team__player-expanded">
              The guy in the office that everyone hates and loves at the same
              time. If you get 10 messages in 5 minutes in the middle of the
              night, you realize without looking at your phone that Ars is
              outlining new tasks again, and another briefing is waiting for you
              the next morning. Word around the office is that the last time he
              slept was in 2007… With 5+ years of vision and development of IT
              projects he knows how to transform any project to fit the trends
              in the markets.
            </p>
            <div className="team__player-socials">
              <a
        ...
        <div className="team__player">
          ...
          <div className="team__player-wrapper">
            ...
            <p className="team__player-expanded">
              Click-click-click….don&apos;t create unnecessary noise, GL works.
              This guy forgot what sunlight is a long time ago. You&apos;d think
              he was a vampire, but no, he converts all these crazy
              people&apos;s ideas into code so he doesn&apos;t have too much
              time to talk. He came straight off the matrix. With 5+ years of
              experience in IT he knows how to build and maintain all the
